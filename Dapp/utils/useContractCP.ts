...
import { contractCPABI } from "./abiCP"

// NFT minting contract address
export const contractCPAddress = process.env.NEXT_PUBLIC_CONTRACT_CP_ADDRESS

export const useContractCP = (isActive: boolean, connector: Connector) => {
